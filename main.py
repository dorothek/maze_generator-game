...
def main():
    ...
    while run:
        ...
        isDownPressed = keyboard.is_pressed("down")
        isUpPressed = keyboard.is_pressed("up")
        isLeftPressed = keyboard.is_pressed("left")
        isRightPressed = keyboard.is_pressed("right")
